    ...
    >
      <div class="flex items-center ml-6 w-1/3">
        <button
          type="button"
          @click="goBack"
          class="rounded-full bg-black p-[1px] hover:bg-[#282828] cursor-pointer transition-colors"
        >
        ...
        <button
          type="button"
          @click="goForward"
          class="rounded-full bg-black p-[1px] hover:bg-[#282828] ml-4 cursor-pointer transition-colors"
        >
          ...
          >
            <div class="flex items-center">
              <img
                ...
                style="object-fit: cover"
              />
              <span class="ml-2" :class="idx === activeAccountIndex ? 'text-white' : ''">{{
                acc.name
              }}</span>
            </div>
